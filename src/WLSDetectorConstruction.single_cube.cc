...
void WLSDetectorConstruction::ConstructFiber()
{
    ...
    #ifdef XFIBER
        G4VPhysicalVolume* physWLSCladOtX = new G4PVPlacement(rotMX, xpVec, fLogiWLSCladOtX, "WLSFiberClad2X", fLogiWorld, false, 0);
    #endif
    #ifdef YFIBER
        G4VPhysicalVolume* physWLSCladOtY = new G4PVPlacement(rotMY, ypVec, fLogiWLSCladOtY, "WLSFiberClad2Y", fLogiWorld, false, 0);
    #endif
    #ifdef ZFIBER
        G4VPhysicalVolume* physWLSCladOtZ = new G4PVPlacement(0,     zpVec, fLogiWLSCladOtZ, "WLSFiberClad2Z", fLogiWorld, false, 0);
    #endif

    #ifdef XFIBER
        new G4LogicalBorderSurface("surfWLSCladOtXWorldOt", physWLSCladOtX, fPhysWorld, opSurfWorldCladOt); // clad2 -> world
        new G4LogicalBorderSurface("surfWLSCladOtXWorldIn", fPhysWorld, physWLSCladOtX, opSurfWorldCladOt); // world -> clad2
    #endif
    #ifdef YFIBER
        new G4LogicalBorderSurface("surfWLSCladOtYWorldOt", physWLSCladOtY, fPhysWorld, opSurfWorldCladOt); // clad2 -> world
        new G4LogicalBorderSurface("surfWLSCladOtYWorldIn", fPhysWorld, physWLSCladOtY, opSurfWorldCladOt); // world -> clad2
    #endif
    #ifdef ZFIBER
        new G4LogicalBorderSurface("surfWLSCladOtZWorldOt", physWLSCladOtZ, fPhysWorld, opSurfWorldCladOt); // clad2 -> world
        new G4LogicalBorderSurface("surfWLSCladOtZWorldIn", fPhysWorld, physWLSCladOtZ, opSurfWorldCladOt); // world -> clad2
    #endif
    ...
    #ifdef XFIBER
        new G4LogicalBorderSurface("surfWLSCladInXOt", physWLSCladInX, physWLSCladOtX, opSurfAmongWLSComps); // clad -> clad2
        new G4LogicalBorderSurface("surfWLSCladInXIn", physWLSCladOtX, physWLSCladInX, opSurfAmongWLSComps); // clad2  -> clad
    #endif
    #ifdef YFIBER
        new G4LogicalBorderSurface("surfWLSCladInYOt", physWLSCladInY, physWLSCladOtY, opSurfAmongWLSComps); // clad -> clad2
        new G4LogicalBorderSurface("surfWLSCladInYIn", physWLSCladOtY, physWLSCladInY, opSurfAmongWLSComps); // clad2  -> clad
    #endif
    #ifdef ZFIBER
        new G4LogicalBorderSurface("surfWLSCladInZOt", physWLSCladInZ, physWLSCladOtZ, opSurfAmongWLSComps); // clad -> clad2
    ...
    //	G4double fiber_pos = 2*mm;
    new G4PVPlacement(rotMX, G4ThreeVector(+fiber_pos, fWLSfiberZ - fWLSfiberl, +fiber_pos), logicPhotonDetX, "PhotonDetX", fLogiWorld, false, 0);
    new G4PVPlacement(rotMY, G4ThreeVector(fWLSfiberZ - fWLSfiberl, +fiber_pos, -fiber_pos), logicPhotonDetY, "PhotonDetY", fLogiWorld, false, 0);
    new G4PVPlacement(0,     G4ThreeVector(-fiber_pos, -fiber_pos, fWLSfiberZ - fWLSfiberl), logicPhotonDetZ, "PhotonDetZ", fLogiWorld, false, 0);
